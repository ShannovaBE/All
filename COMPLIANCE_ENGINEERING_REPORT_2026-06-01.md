...
1. Implement API-level licence/KYB access control for dataset download and buyer preview flows.
2. Build Data Subject Rights APIs for export, restriction, and deletion.
3. Add durable provenance fields and a dataset compliance evidence record.
4. Add retention automation.
5. Replace SHA-256 password hashing with a real password hasher such as Argon2 or bcrypt.
6. Add CI that runs backend unit tests, frontend lint, secret scanning, and dependency scanning on every push.
